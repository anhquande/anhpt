...
class WorkoutParser {
  ...
  static const _stepFields = {'name', 'duration', 'guide'};
  ...
  static List<WorkoutNode> _nodes(YamlList list, int depth) {
    ...
    for (final item in list) {
      ...
      if (map.containsKey('repeat')) {
        ...
        out.add(WorkoutStep(name: name, duration: duration, guide: guide));
      }
    }
    return out;
  }
  ...
  static String generateId() {
    ...
    return '${now.toRadixString(16)}-'
        '${randomA.toRadixString(16)}-'
        '${randomB.toRadixString(16)}';
  }
}

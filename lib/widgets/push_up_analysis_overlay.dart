...
/// Small live diagnostic overlay for push-up analysis.
class PushUpAnalysisOverlay extends StatelessWidget {
  const PushUpAnalysisOverlay({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      label: 'Push-up analysis. ${analysis.repetitionCount} repetitions. '
          'State $stateLabel.',
      child: ConstrainedBox(
        constraints: const BoxConstraints(maxWidth: 360),
        child: DecoratedBox(
          key: const ValueKey('push-up-analysis-overlay'),
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      'Push-ups ${analysis.repetitionCount}',

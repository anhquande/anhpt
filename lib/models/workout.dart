...
class VoiceConfig {
  ...
  final bool announceInterval;
  final bool announceFinalCountdown;
  ...
  const VoiceConfig({
    ...
    required this.announceElapsedTime,
    required this.announceInterval,
    required this.announceFinalCountdown,
  ...
  static VoiceConfig fromJson(Map<String, dynamic> j) => VoiceConfig(
    ...
    announceElapsedTime: j['announceElapsedTime'] as bool,
    announceInterval: j['announceInterval'] as bool,
    announceFinalCountdown: j['announceFinalCountdown'] as bool,
...
class Workout {
    ...
    void walk(
      ...
      for (var nodeIndex = 0; nodeIndex < nodes.length; nodeIndex++) {
        ...
        if (node is WorkoutStep) {
          result.add(
            ExecutableStep(step: node, stepKey: nodePath, repeat: activeRepeat),
          );
  ...
  static Workout fromJson(Map<String, dynamic> j) => Workout(
    ...
    exercises: (j['exercises'] as List? ?? const [])
        .map(
          (value) => Exercise.fromJson(Map<String, dynamic>.from(value as Map)),
        )
        .toList(),
    steps: (j['steps'] as List)
        .map((e) => workoutNodeFromJson(Map<String, dynamic>.from(e as Map)))

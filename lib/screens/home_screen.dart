    ...
    return Scaffold(
            ...
            onPressed: () => Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (_) => WorkoutEditorScreen(
                        controller: controller, importMode: true))),
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => Navigator.push(
            context,
            MaterialPageRoute(
                builder: (_) => WorkoutBuilderScreen(controller: controller))),
              ...
              children: [
                ...
                if (controller.favorites.isNotEmpty) ...[
                  ...
                  for (final w in controller.favorites) ...[
                    WorkoutCard(
                        workout: w,
                        onOpen: () => _openDetail(context, w),
                        onStart: () => _start(context, w),
                        onFavorite: () => controller.toggleFavorite(w.id)),
                    const SizedBox(height: 10),
                  ],
                  const SizedBox(height: 22),
                ],
                const SectionTitle('My Workouts'),
                const SizedBox(height: 10),
